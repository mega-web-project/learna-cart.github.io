...
<!--Caption carousel ends here-->
    ...
    <div class="row row-cols-1 row-cols-md-4 g-4 row-1">
        <div class="col">
          <div class="card">
            <img src="../images/account.jpg" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card card-3">
            <img src="../images/arch.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Card title</h5>
        ...
        <div class="col">
            <div class="card">
              <img src="../images/curriculum.jpg" class="card-img-top" alt="...">
              <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
              </div>
